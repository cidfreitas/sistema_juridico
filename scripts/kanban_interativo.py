#!/usr/bin/env python3
"""
Gera Kanban com drag-and-drop e reordenação dentro das colunas
"""
...
# HTML com Drag-and-Drop + Reordenação
html = '''<!DOCTYPE html>
<html lang="pt-BR">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Kanban Interativo - Seu Sistema Jurídico</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            <h1>⚖️ Kanban Jurídico Interativo</h1>
            <p>Processos | Andamentos</p>
        </div>
        
        <div class="info">
            💡 Dicas: Arraste para mover entre colunas OU reordenar dentro da coluna
        </div>
        ...
        <div class="footer">
            <p>✅ Mudanças salvas automaticamente no navegador</p>
        </div>
    </div>
    ...
    <script>
        ...
        function renderizar() {
            ...
            Object.entries(estadoAtual).forEach(([status, processos]) => {
                ...
                processos.forEach((p, idx) => {
                    cardsHTML += `
                        <div class="process-card ${status}" draggable="true" data-cnj="${p.cnj}" data-index="${idx}">
        ...
        console.log('✅ Kanban interativo com reordenação carregado!');
    </script>
</body>
</html>
'''
...
print("✅ Kanban com reordenação criado!")
